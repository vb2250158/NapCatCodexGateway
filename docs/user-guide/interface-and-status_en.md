...
The Plans & Memory content area starts directly with summary counters, followed by categories, search, the plan directory, and the list. The page title and persona switcher remain in the top bar.
